        ...
        private void OnGUI()
        {
            ...
            if (requireCleanInstall) {
                ...
                if (priorVersionInstalled) {
                    EditorGUILayout.HelpBox("Version 2.4 contains major structural changes. Before importing remove the Opsive/UltimateCharacterController and Opsive/Shared folders. " +
