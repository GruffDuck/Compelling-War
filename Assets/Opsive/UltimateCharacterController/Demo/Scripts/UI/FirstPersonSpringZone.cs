    ...
    public class FirstPersonSpringZone : UIZone
    {
        ...
        protected override void CharacterExit(UltimateCharacterLocomotion characterLocomotion)
        {
            ...
            if (characterLocomotion.gameObject != m_Character){
                var characterTransform = characterLocomotion.transform;
                m_Character.GetComponent<UltimateCharacterLocomotion>().SetPositionAndRotation(characterTransform.position, characterTransform.rotation);
            }
